<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SM_controlcenter.ascx.cs" Inherits="Control_SM_controlcenter" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="aid" HeaderText="区域ID" />
